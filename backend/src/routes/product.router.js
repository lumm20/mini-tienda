...
import { validateProduct, validateProductId } from '../middlewares/validators/productValidator.js';
...
productRouter.put('/:id',validateProductId(),checkResults,controller.updateProduct);
